...
if (layout_reset) {
  layout_reset.addEventListener('click', function (e) {
    ...
    setCookie('font_name', 'Public-Sans', 1);
    location.reload();
  });
}
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (control) {
      document.querySelector('.themepreset-color > a.active').classList.remove('active');
      document.querySelector(".themepreset-color > a[data-value='true']").classList.add('active');
    ...
    if (control) {
      document.querySelector('.themepreset-color > a.active').classList.remove('active');
      document.querySelector(".themepreset-color > a[data-value='false']").classList.add('active');
      if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
...
function change_box_container(value) {
  if (document.querySelector('.pc-content')) {
    ...
    if (value == 'true') {
      ...
      if (control) {
        document.querySelector('.boxwidthpreset > a.active').classList.remove('active');
        document.querySelector(".boxwidthpreset > a[data-value='true']").classList.add('active');
      }
    } else {
      ...
      if (control) {
        document.querySelector('.boxwidthpreset > a.active').classList.remove('active');
        document.querySelector(".boxwidthpreset > a[data-value='false']").classList.add('active');
      }
    }
  }
}
function preset_change(value) {
  ...
  setCookie('preset_color', value, 1);
  var control = document.querySelector('.pct-offcanvas');
  if (control) {
